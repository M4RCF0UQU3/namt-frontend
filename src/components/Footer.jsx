...
<p>Vous êtes actuellement connecté au Site “Tomate pourrie”, ci-après : le Site. </p>
...
<p>
	...
	<h3>Adresse</h3>
	12 Rue de la Courgette<br/>
	31000 Toulouse<br/>
	<h3>Courriel</h3>
	pourritavie@mail.com<br/>
	<h3>Téléphone</h3>	
	11 11 22 22 11
</p>
<p>
...
<p>
	...
	Les données personnelles que nous pourrions être amenés à recueillir sont exclusivement destinées à Tomate pourrie pour vous permettre de profiter des Services offerts par le Site. Aucune information personnelle vous concernant n'est cédée à des tiers ou utilisée à des fins non prévues sans votre autorisation préalable.
	Conformément à la loi n° 78-17 du 6 janvier 1978 modifiée, vous disposez d’un droit d’accès, de modification, de rectification et de suppression des données personnelles que nous pourrions être amenés à recueillir.
</p>
<p>
...
Tomate pourrie se réserve le droit de mettre à jour la présente notice légale à tout moment. 
Tomate pourrie vous invite les utilisateurs à viSiter cette page lors de chaque consultation du Site afin d’en prendre connaissance.
